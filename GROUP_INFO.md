...
## 可用 Skill
1. link-card：链接自动抓取、内容质量判断、卡片回复
2. long-read：长文精读：收到微信公众号/飞书文档/网页链接或粘贴长文，自动提取正文→结构化拆解→三段式精读摘要→按内容自动选择 ljg 深度链路→输出回飞书群或生成飞书文档

## 数据源
- 精读索引：https://ywhome.feishu.cn/base/ASdsbB3Gka9OKNsD7YhcJ9rZnjd
- GitHub：https://github.com/SimplyY/read-x
- README.md：阅读系统：链接自动抓取、内容质量判断、卡片回复、长文精读、飞书文档输出。同时管理微信读书。
...
- 链接数：2
- Skill 扫描：正常
- 最近更新时间：2026-07-17T00:01:27.448Z
