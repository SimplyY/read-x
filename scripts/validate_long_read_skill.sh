...
require 'scripts/run_long_read_pipeline.py'
require 'scripts/run_isolated_analyses.py'
require 'scripts/run_chatgpt_munger.py'
require 'scripts/run_chatgpt_core_image.py'
require 'markdown_to_feishu_xml.py'
require 'render_long_read_delivery_card.py'
require 'article-decode 失败不得阻断 ChatGPT'
require '主精读完成，ChatGPT 待复核'
require '主文档降级交付'
require 'attempts_detail'
require '禁止自动重发'
require 'ChatGPT Bridge'
require 'live-dom+snapshot'
require '失败关闭'
require '不得在脚本失败时回退角色扮演'
require '严格校验 Evidence Schema'
require '并发 ≤3 路'
require '错开 ≥10 秒'
require 'lark-cli docs +media-insert'
